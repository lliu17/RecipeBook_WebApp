...
function printItems(result, res) {
    ...
    if (result.length > 0) {
        for (var i = 0; i < result.length; i++) {
            ...
            if (result[i].utensions.length == 1) {
